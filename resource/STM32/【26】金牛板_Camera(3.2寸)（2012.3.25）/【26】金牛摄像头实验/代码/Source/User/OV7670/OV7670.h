...
static const int change_reg[CHANGE_REG_NUM][2]= 
{
 	{0x3a, 0x04},
	{0x40, 0x10},  //0XD0:RGB565输出   0X10:一般RGB输出
	{0x12, 0x14},  //
	{0x32, 0x80},
	{0x17, 0x16},
	{0x18, 0x04},
...
//FIFO_DATA_PIN		 PE0-8
***********************************************************/
#define	   FIFO_RE  	PBout(8)	 	//CS
#define	   FIFO_RRST  	PBout(9)		//RRST
#define	   FIFO_RCLK  	PBout(10)		//RD
#define	   FIFO_WRST  	PBout(11)		//WRST
#define	   FIFO_WEN  	PBout(14)		//WE
#define    FIFO_DATA_PIN	  (GPIOA->IDR & 0x00ff)	          //配置为输入

#define    OV7670_XCLK_BIT	  GPIO_Pin_8				 //STM32只有PA8输出系统时钟

#define    OV7670_VSYNC_BIT	  GPIO_Pin_12				 //帧频信号引脚
